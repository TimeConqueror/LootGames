...
public class LootGameCleaner {
    private static final BlockState DUNGEON_FLOOR = BlockState.of(LGBlocks.DUNGEON_WALL, DungeonBrick.eDungeonBricks.FLOOR.ordinal());
    private static final BlockState SHIELDED_FLOOR = BlockState.of(LGBlocks.DUNGEON_WALL, DungeonBrick.eDungeonBricks.FLOOR_SHIELDED.ordinal());
