...
import eu.usrv.lootgames.chess.blocks.BlockChessBlock;
import eu.usrv.lootgames.chess.entities.*;
...
public class ChessGame implements ILootGame {
    ...
    private static Block SQUARE_WHITE = Blocks.quartz_block;
    private static Block SQUARE_BLACK = Blocks.obsidian;
